...
class CentralBanksSpeechesScraper(scrapy.Spider):
    ...
    bank_pattern = re.compile('.*of\sthe\s(?P<bank_name>.*)')
    ...
    def scrape_speech_speaker(self, speech_dict, speaker_info):
        ...
        speaker_gender = self.get_speaker_gender(speaker_gender_phrase)
    ...
    def scrape_speech_as_pdf(self, item, speech_url):
        ...
        speaker_info = item.css(".info *::text").extract()[1:-1]
    ...
    def scrape_speech_as_htm(self, response):
        ...
        speaker_info = speech_center.css("#extratitle-div  *::text").extract()[1:-1]
        self.scrape_speech_speaker(speech_dict, speaker_info)
    ...
    def get_speaker_gender(self, speaker_gender_phrase):
        """"""

        if speaker_gender_phrase=="Mr" or speaker_gender_phrase=="Dr":
            return  "male"
